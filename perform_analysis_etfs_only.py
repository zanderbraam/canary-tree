...
# Get the data
input_data = pd.read_csv("./data/transformed/input_data_etfs_only.csv")
target_data = pd.read_csv("./data/transformed/target_data_etfs_only.csv")
...
if os.path.exists("./data/best_parameters/best_hyperparameters_etfs_only.json"):
    # Load from JSON
    with open("./data/best_parameters/best_hyperparameters_etfs_only.json", "r") as f:
        loaded_params = json.load(f)

    model = XGBClassifier(**loaded_params, scale_pos_weight=scale_pos_weight)
    ...
    # Save to JSON
    with open("./data/best_parameters/best_hyperparameters_etfs_only.json", "w") as f:
